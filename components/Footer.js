function Footer() {
  try {
    ...
    const socialLinks = [
      {
        icon: "github",
        url: "https://github.com/joaotavaresjose",
        label: "GitHub",
      },
      {
        icon: "linkedin",
        url: "https://linkedin.com/in/joao-tavares-jose",
        label: "LinkedIn",
      },
      {
        icon: "instagram",
        url: "https://instagram.com/joaotavares",
        label: "Instagram",
      },
      {
        icon: "message-circle",
        url: "https://wa.me/244951184916",
        label: "WhatsApp",
      },
    ];
    ...
    return (
      <footer
        className="bg-[var(--text-primary)] text-white section-padding"
        data-name="footer"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gradient leading-tight">
                    João Tavares José
                  </h3>
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                ...
                criando soluções digitais inovadoras que conectam pessoas e
                geram resultados excepcionais para empresas.
              </p>
          ...
          <div className="text-center py-8 border-t border-b border-gray-700">
            <p className="text-lg italic text-gray-300 mb-2">
              "Código é poesia, design é arte, juntos criam experiências
              inesquecíveis."
            </p>
